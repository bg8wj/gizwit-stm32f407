...
* @{
*/
#define PRODUCT_KEY "6e5d2d7ccecb4033a5c4573f8d20881f"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "2211a5f8151a4ed29bd93fdceefae210"
...
* @{
*/
#define Temperture_ALM_BYTEOFFSET                    2
#define Temperture_ALM_BITOFFSET                     0
#define Temperture_ALM_LEN                           1
#define hum_ALM_BYTEOFFSET                    2
#define hum_ALM_BITOFFSET                     1
#define hum_ALM_LEN                           1

#define Temperture_RATIO                         1
#define Temperture_ADDITION                      0
#define Temperture_MIN                           0
#define Temperture_MAX                           100
...
typedef struct {
  uint32_t valueTemperture;
  uint32_t valueHumidity;
  bool valueTemperture_ALM;
  bool valuehum_ALM;
} dataPoint_t;
